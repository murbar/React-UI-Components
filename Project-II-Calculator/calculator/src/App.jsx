    ...
    return (
      <div className="calculator-container">
        ...
        <ButtonRow>
          ...
          <ActionButton value="÷" buttonStyle="button-action" onPress={this.handleOperatorPress} />
        </ButtonRow>
        <ButtonRow>
        ...
        <ButtonRow>
          ...
          <ActionButton value="=" buttonStyle="button-action" onPress={this.handleEqualsPress} />
        </ButtonRow>
      </div>
    );
  }
